    ...
    render: async () => {
        try {
            ...
            if (!Array.isArray(postArray)) {
                ...
                else if (posts && Array.isArray(posts.items))
                    postArray = posts.items;
                else if (posts && Array.isArray(posts.rows))
                    postArray = posts.rows;
            }
            if (!Array.isArray(postArray)) {
...
//# sourceMappingURL=socialFeed.plugin.js.map