...
const dev_debug_controller_1 = require("./dev-debug.controller");
...
exports.DevAuthModule = DevAuthModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [dev_auth_controller_1.DevAuthController, dev_debug_controller_1.DevDebugController],
    })
], DevAuthModule);
