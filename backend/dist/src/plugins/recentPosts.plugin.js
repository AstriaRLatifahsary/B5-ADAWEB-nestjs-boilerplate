...
pluginManager_1.PluginManager.register({
    ...
    render() {
        const posts = [
            {
                title: 'Na Daehoon Resmi Gugat Cerai Julia Prastini, Usai Isu Perselingkuhan Viral',
                date: '2025-10-15',
            },
            {
                title: 'Tasya Farasya Ajukan Gugatan Cerai dari Ahmad Assegaf, Diajukan 29 September 2025',
                date: '2025-10-10',
            },
            {
                title: 'Sabrina Chairunnisa Gugat Cerai Deddy Corbuzier di Pengadilan Agama Jakarta Selatan',
                date: '2025-10-08',
            },
        ];
        return `
      ...
      <div class="recent-posts">
        ...
        <ul>
          ${posts
            .map((p) => `<li><strong title="${p.title}">${p.title}</strong><small>${p.date}</small></li>`)
            .join('')}
        </ul>
      </div>
    `;
...
//# sourceMappingURL=recentPosts.plugin.js.map